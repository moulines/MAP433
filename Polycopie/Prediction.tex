...
% \eqref{eq:YW2} peuvent encore être r\'e\'ecrites \`a partir des
...
$$
% La projection orthogonale d'un AR$(m)$ causal sur son pass\'e de longueur $p\geq m$ coïncide avec la projection
...
coïncident avec les coefficients de pr\'ediction directe.
...
projet\'es sur le même sous-espace
