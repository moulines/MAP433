...
\begin{example}[Battements cardiaques]
  ...
  Ce rythme est mesuré en nombre de battements par minute toutes les $0.5$
  secondes.
%========= FIGURE
\figscale{\FIGPASSL hr11839}
 {Battements cardiaques: évolution du nombre de battements par minute
 en fonction du temps mesuré en seconde.}{fig:figcard1}{1}
\end{example}
