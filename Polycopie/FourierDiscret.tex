...
\begin{definition}[Opérateur de décalage]
...
\begin{enumerate}[label=(\roman*)]
\item $\TFA{S^m u}(\nu)= \rme^{- 2 \rmi \pi m \nu} \TFA{u}(\nu)$ pour tout $\nu \in \coint{-1/2,1/2}$, où $S$ est l'opérateur de décalage (voir \Cref{def:operateur-decalage}).
\item $\TFA{\delta}(\nu) = 1$ pour tout $\nu \in \coint{-1/2,1/2}$.
...
\item \label{item:definition-SLI-commute} $T$ commute avec l'opérateur de décalage $S$ (voir \Cref{def:operateur-decalage}): $S \circ T= T \circ S$.
\end{enumerate}
\end{definition}
Remarquons que \Cref{def:definition-SLI}-\ref{item:definition-SLI-commute} implique que pour tout $m \in \zset$, $S^m \circ T= T \circ S^m$.
...
$$
Lorsque l'on applique l'op\'erateur décalage $S^m$ à la suite p\'eriodis\'ee, nous obtenons de nouveau une suite p\'eriodique de p\'eriode $N$.
