...
\item Soit $f \in L_2(\rset)$ On a $\TFA \TFA f = f_\sigma$ p.p. où $f_\sigma(x)= f(-x)$
...
$\lim_{n \to \infty} \norm{f-f_n}[2]=0$ (voir \Cref{theo:densite-mcs-Lp}). On a $\TFA f_n = \TFA (f_n)_\sigma$. En passant à la limite, on a donc $\TFA f= \TFAC f_\sigma$ (remarquons que $\norm{f_\sigma - (f_n)_\sigma}[2]=0$).
...
\end{align*} 
En proc\'edant de la même façon on obtient
\[
