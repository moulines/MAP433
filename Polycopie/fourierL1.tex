...
\end{proposition}
\begin{proof}
La preuve élémentaire est laissée aux lecteurs.
\end{proof}
...
$$
\item Si $f$ est $n$ fois continûment d{\'e}rivables avec $f^{(k)} \in L_1(\rset)$ pour tout $k=0,1, \dots, n$, alors
$$
...
$\lim_{a \to \infty} f(a) $ existe. Cette limite est n{\'e}cessairement nulle car $f \in L_1(\rset)$. De la m{\^e}me façon,
...
d{\'e}rivation et multiplication par un polyn{\^o}me. Cet espace introduit par Laurent Schwartz et que l'on notera $\mcs$ joue un rôle essentiel en analyse de Fourier.
...
$$
\item $f_{5}(x)=\rme^{-a|x|}, {\rm Re}(a)>0$. Nous déduisons des calculs précédents
$$
