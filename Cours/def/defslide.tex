...
\usepackage{amsmath,amssymb,amstext,amsthm,xargs,ifthen}
\usepackage{amsfonts}
\usepackage{bbm}
...
\newcommandx{\plim}[1][1=]{\stackrel{#1}{\longrightarrow}}
\def\iid{i.i.d.}
\def\1{\mathbbm{1}}
...
\newcommandx{\projX}[1][1=\regressmat]{\Pi_{#1}}
\def\curtheta{\alpha}
...
\def\zreject{\mathcal{R}}
\def\zaccept{\mathcal{A}}
\def\puissance{\pi}
\def\rmd{\mathrm{d}}
\def\binom{\mathrm{Bin}}
