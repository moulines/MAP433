...
\end{equation*}
\only<1>{
\item Maximisation de la vraisemblance pour $\mu=0$ (on maximise par rapport à $\sigma^2$) 
\[
\sigma^2 \mapsto -(n/2) \log \sigma^2 -(1/2\sigma^2) \sum_{i=1}^n X_i^2
\]
Le maximum de vraisemblance est $\hat{\sigma}_{n,0}^2 = n^{-1} \sum_{i=1}^n X_i^2$ et la vraisemblance au maximum est 
\[
(\hat{\sigma}_{n,0})^{-n} \exp(- (1/2 \hat{\sigma}^2_{n,0}) \sum_{i=1}^n X_i^2)=  \left( \sum_{i=1}^n X_i^2 \right)^{-n} \exp(-n/2)
\]
}
\only<2>
{
