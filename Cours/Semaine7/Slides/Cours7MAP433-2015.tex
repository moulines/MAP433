...
\begin{itemize}
\item \underline{Situation} : on part d'une expérience statistique $\big(\mathfrak{Z}, {\mathcal Z},\{\PP_\truetheta, \truetheta \in \Theta\}\big)$ engendrée par l'observation $Z$.
...
%étudie séparément l'erreur de seconde espèce
 ...
 \item \alert{Simplification} cadre asymptotique (où la gaussianité réappara”t le plus souvent...).
\end{itemize}
...
\begin{itemize}
\item \underline{Situation} la suite d'expériences $\big(\mathfrak{Z}^n, {\mathcal Z}^n,\{\PP_\truetheta^n,\truetheta \in \Theta\}\big)$ est engendrée par l'observation $Z^n$, $\truetheta \in \Theta \subset \R$
