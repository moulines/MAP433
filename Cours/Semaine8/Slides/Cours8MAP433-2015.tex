...
$$ 
\item On cherche à tester si $\PE_{\truebeta,\sigma^2}[\bY] \in \vect(\regressmat_0)$ où $\vect(\regressmat_0) \subset \vect(\regressmat)$ 
est un sous espace linéaire (strict) de $\vect(\regressmat)$
