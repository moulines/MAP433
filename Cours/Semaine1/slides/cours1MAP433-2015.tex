...
\item Exp\'erience statistique {\color{red} (1 cours)}.
...
\begin{figure}
  ...
  \includegraphics[width=0.7\textwidth]{prostate}
  \caption{Identifier les facteurs de risque pour le d\'eveloppement d'un cancer}
\end{figure}
\end{frame}

\begin{frame}
\frametitle{G\'enomique-Prot\'eomique}
\begin{figure}
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=0.7\textwidth]{biopuce1}
  \caption{classifier des tissus en fonctions de donn\'ees d'expression de g\^enes}
\end{figure}
\end{frame}
