...
\usepackage{a4wide,amsmath,amssymb,bbm,fancyhdr,xcolor}
...
\]
\item \textcolor{blue}{Attention, dans ce corrigé, $v$ désigne l'écart-type et
    $v^2$ la variance.} L'information de Fisher est
\[
I_n(\theta) =  \frac{n}{v^4}  
\begin{bmatrix}
  v^2 & 0 \\
